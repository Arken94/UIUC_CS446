...
class TFTests(unittest.TestCase):
    def setUp(self):
        ...
        self.model_W0 = None
        try:
            self.model = logistic_model.LogisticModel_TF(ndims=16,
                                                         W_init='zeros')
    ...
    def test_dataset_shape(self):
        self.assertEqual(self.A.shape, (1290, 17))
        self.assertEqual(self.T.shape, (1290, 1))
    ...
    def test_init_weight_shape(self):
        self.assertEqual(self.model_W0.shape, (17, 1))
