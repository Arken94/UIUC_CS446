...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_float('learning_rate', 0.00000001, 'Initial learning rate.')
flags.DEFINE_float('w_decay_factor', 0.000001, 'Weight decay factor.')
...
def main(_):
    ...
    if opt_method == 'iter':
        ...
        train_model(train_set, model, learning_rate, num_steps=num_steps, shuffle=True)
